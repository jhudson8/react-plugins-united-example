...
/*!
 * [backbone-async-event](https://github.com/jhudson8/backbone-async-event) v0.1.3;  MIT license; Joe Hudson<joehud_AT_gmail.com>
 */
...
/*!
 * [react-mixin-manager](https://github.com/jhudson8/react-mixin-manager) v0.3.0;  MIT license; Joe Hudson<joehud_AT_gmail.com>
 */
...
/*!
 * [react-events](https://github.com/jhudson8/react-events) v0.1.2;  MIT license; Joe Hudson<joehud_AT_gmail.com>
 */
!function(n){"function"==typeof define&&define.amd?define(["react"],n):"undefined"!=typeof exports&&"undefined"!=typeof require?module.exports=function(t){n(t)}:n(React)}(function(n){function t(n,t,o){var f=t;if("string"==typeof t&&(f=o[t]),!t)throw'no callback function exists for "'+t+'"';t=function(){return f.apply(o,arguments)};var r=n.match(i),a=r[1],u=e[a],s=r[2];if(!u)throw'no handler registered for "'+n+'"';return u.call(o,{path:s},t)}var e={},i=/^([^:]+):?(.*)/,o={standard:function(n){var t={on:n.onKey||"on",off:n.offKey||"off"},e=n.target;return function(i,o){function f(n,i){return function(){var f="function"==typeof e?e.call(i,r):e;f&&f[t[n]](r,o)}}var r=i.path;return{on:f("on",this),off:f("off",this),initialize:n.initialize}}}},f=n.events={handle:function(n,t){"function"!=typeof t&&(t=o[t.type||"standard"](t)),e[n]=t}};"undefined"!=typeof window&&f.handle("window",{target:window,onKey:"addEventListener",offKey:"removeEventListener"}),f.handle("ref",function(n,t){var e=n.path.match(i),o=e[1],f=e[2];return{on:function(){var n=this.refs[o];n&&n.on(f,t)},off:function(){var n=this.refs[o];n&&n.off(f,t)}}}),f.handle("dom",function(n,t){var e=n.path.match(i);return{on:function(){$(this.getDOMNode()).on(e[1],e[2],t)},off:function(){$(this.getDOMNode()).off(e[1],e[2],t)}}}),n.mixins.add("events",function(){var n={getInitialState:function(){var n=this._eventHandlers=[];if(this.events){var e;for(var i in this.events)e=t(i,this.events[i],this),e.initialize&&e.initialize.call(this),n.push(e)}return null},componentDidMount:function(){for(var n=this._eventHandlers,t=0;t<n.length;t++)n[t].on.call(this)},componentWillUnmount:function(){for(var n=this._eventHandlers,t=0;t<n.length;t++)n[t].off.call(this)}};return[n,f.mixin]})});


/*!
 * [react-backbone](https://github.com/jhudson8/react-backbone) v0.1.2;  MIT license; Joe Hudson<joehud_AT_gmail.com>
 */
!function(e){"function"==typeof define&&define.amd?define(["react","backbone","underscore"],e):"undefined"!=typeof exports&&"undefined"!=typeof require?module.exports=function(t,n){e(t,n,require("underscore"))}:e(React,Backbone,_)}(function(e,t,n){function i(e,t,n,i){if(i=i||this,this.__modelEvents||(this.__modelEvents={}),this.__modelEvents[t]={type:e,callback:n,context:i},this.isMounted()){var o=this.getModel();o&&o[e](t,n,i)}}e.mixins.add("modelAccessor",{getModel:function(){return this.model||this.props.model},setModel:function(e){this._modelUnbindAll&&this._modelUnbindAll(!0),this.model=e,this._modelBindAll&&this.isMounted()&&this._modelBindAll()}}),e.mixins.add("modelValueAccessor",{getModelValue:function(){var e=this.props.key,t=this.getModel();return t&&e?t.get(e):void 0},setModelValue:function(e,t){var n=this.props.key,i=this.getModel();return i&&n?i.set(n,e,t):void 0}},"modelAccessor"),e.mixins.add("modelEventBinder",{modelOn:function(e,t,n){i.call(this,"on",e,t,n)},modelOnce:function(e,t,n){i.call(this,"once",e,t,n)},modelOff:function(e,t,n){if(this.__modelEvents){var i=this.__modelEvents[e],o=this.getModel();o&&i?o.off(e,t,n||this):i&&delete this.__modelEvents[e]}},_modelBindAll:function(){if(this.__modelEvents){var e=this.getModel();e&&n.each(this.__modelEvents,function(t,n){e[t.type](n,t.callback,t.context)})}},_modelUnbindAll:function(e){if(this.__modelEvents){var t=this.getModel();t&&n.each(this.__modelEvents,function(e,n){t.off(n,e.callback,e.context)}),e||delete this.__modelEvents}},componentDidMount:function(){this._modelUnbindAll(!0),this._modelBindAll(!0)},componentWillUnmount:function(){this._modelUnbindAll(!0)}},"modelAccessor"),e.mixins.add("modelChangeListener",{getInitialState:function(){return n.each(["change","reset","add","remove","sort"],function(e){this.modelOn(e,function(){this.forceUpdate()})},this),null}},"modelEventBinder"),e.mixins.add("modelAsyncListener",{getInitialState:function(){this.modelOn("async",function(e,t){this.setState({loading:!0});var n=this.getModel();t.on("success",function(){this.setState({loading:!!n.isLoading()})},this),t.on("error",function(e){this.setState({loading:!!n.isLoading(),error:e})},this)});var e=this.getModel();return e&&e.isLoading()?{loading:!0}:{}},componentDidMount:function(){var e=this.state,t=this.getModel();t&&(t.isLoading()?(this.modelOnce("async:load-complete",function(){this.setState({loading:!1})}),e.loading||this.setState({loading:!0})):e.loading&&this.setState({loading:!1}))}},"modelEventBinder"),e.mixins.add("modelFieldValidator",{getInitialState:function(){var e=this.props.key;return e&&this.modelOn("invalid",function(t,n){n=this.modelIndexErrors(n)||{};var i=n[e];i&&this.setState({error:i})}),null}},"modelIndexErrors","modelEventBinder"),e.mixins.add("modelIndexErrors",{modelIndexErrors:function(e){if(Array.isArray(e)){var t={};return n.each(e,function(e){for(var n in e)t[n]=e[n]}),t}return e}}),e.mixins.add("modelLoadOn",{getInitialState:function(){var e=this.props.loadOn;return this.modelOn("async:"+e,function(e){this.setState({loading:!0}),e.on("complete",function(){this.setState({loading:!1})},this)}),{}}},"modelEventBinder"),e.events&&(e.events.mixin=e.events.mixin||t.Events,e.events.handle("model",function(e,t){return{on:function(){this.modelOn(e.path,t)},off:function(){}}}))});
...
/*!
 * [react-semantic-ui](https://github.com/jhudson8/react-semantic-ui) v0.1.1;  MIT license; Joe Hudson<joehud_AT_gmail.com>
 */
!function e(t,a,s){function i(n,l){if(!a[n]){if(!t[n]){var o="function"==typeof require&&require;if(!l&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var c=a[n]={exports:{}};t[n][0].call(c.exports,function(e){var a=t[n][1][e];return i(a?a:e)},c,c.exports,e,t,a,s)}return a[n].exports}for(var r="function"==typeof require&&require,n=0;n<s.length;n++)i(s[n]);return i}({1:[function(e,t){(function(a){function s(t){var a=e("./lib/common")(t),s=e("./lib/form")(t,a);return{form:s,input:e("./lib/input")(t,s,a),layout:e("./lib/layout")(t,a)}}a.React?a.rsui=s(a.React):t.exports=s}).call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./lib/common":2,"./lib/form":3,"./lib/input":4,"./lib/layout":5}],2:[function(e,t){var a={id:0};t.exports=function(e){return{uniqueId:function(){return"rsui-"+a.id++},defaults:function(){for(var e,t=arguments[0],a=1;a<arguments.length;a++){e=arguments[a];for(var s in e)void 0===t[s]&&(t[s]=e[s])}return t},omit:function(e,t){var a={};for(var s in e)-1===t.indexOf(s)&&(a[s]=e[s]);return a},mergeClassNames:function(){for(var e="",t=0;t<arguments.length;t++)arguments[t]&&(e.length>0&&(e+=" "),e+=arguments[t]);return e&&e},eventBinder:function(e,t,a,s){return function(i){s&&(i.stopPropagation(),i.preventDefault()),a[t]&&a[t](e,i),a.props[t]&&a.props[t](e,i)}},result:function(e,t){return"function"==typeof e?e.call(t):e},init:function(t,a,s){function i(){for(var i in a){var n=a[i],l={};for(var o in n)l[o]=n[o];if(s.defaults)for(var c in s.defaults)l[c]||(l[c]=s.defaults[c]);l.mixins=[l.mixins,r[i],r.all,s.mixins],t[i]=e.createClass(l)}}s=s||{};var r=t.mixins;t.mixins||(r=t.mixins||{all:[]}),t.reset=i,t.classData=a,i()}}}},{}],3:[function(e,t){t.exports=function(e,t){var a={errorRenderer:function(t,a){a.push(e.DOM.div({className:"ui red pointing top ui label"},t))},applyIcon:function(t){var a=[];a.push(e.DOM.i({className:"icon "+t.icon})),e.Children.forEach(t.children,function(e){a.push(e)}),t.children=a},applyLoadingState:function(e){e.icon="loading",e.disabled=!0,this.props.loadingMessage&&(e.children=this.props.loadingMessage)},fieldRenderer:function(){var s=this.props,i=this.state||{},r=t.mergeClassNames("field",this._controlClassName&&this._controlClassName()),n=this.props.id;labelAfter=void 0!==s.labelAfter?s.labelAfter:this.defaultLabelAfter,inlineLabel=void 0!==s.inlineLabel?s.inlineLabel:this.defaultInlineLabel,containerClass=t.mergeClassNames(s.containerClass,this.defaultContainerClass&&this.defaultContainerClass()),inputFieldProps=t.omit(s,["label","disabled","fieldClass","value"]),error=s.error||i.error,error&&(r=t.mergeClassNames(r,"error")),this.props.disabled&&(r=t.mergeClassNames(r,"disabled")),s.fieldClass&&(r=t.mergeClassNames(s.fieldClass,r)),s.label&&!n&&(n=t.uniqueId()),(i.loading||s.loading)&&(containerClass=t.mergeClassNames(containerClass,"loading")),inputFieldProps.id=n,inputFieldProps.defaultDisabled=this.props.disabled,this.modifyInputFieldProps&&(inputFieldProps=this.modifyInputFieldProps(inputFieldProps));var l=this.renderInput(inputFieldProps),o=s.label?e.DOM.label({htmlFor:n},s.label):void 0,c=[],u=[];if(containerClass){u.push(l),inlineLabel&&o&&(u.splice(labelAfter?1:0,0,o),o=void 0),error&&(this.errorRenderer?this.errorRenderer(error,u):a.errorRenderer.call(this,error,u));var d=e.DOM.div({className:containerClass},u);if(!o)return d;c.push(d)}else{if(!o)return l;c.push(l),error&&(this.errorRenderer?this.errorRenderer(error,c):a.errorRenderer.call(this,error,c))}return o&&c.splice(labelAfter?1:0,0,o),e.DOM.div({className:r},c)}},s={Form:{render:function(){var a=this.props,s=a.loading||this.state&&this.state.loading;return attributes=t.defaults({className:t.mergeClassNames("ui form",this._className,a.className,s&&"loading")},this.props),e.DOM.form(attributes,a.children)}},Control:{render:a.fieldRenderer,renderInput:function(){return this.props.children},_controlClassName:function(){return this._className}},Button:{render:function(){var s=this.props,i=this.state||{},r={children:s.children,className:s.className,disabled:s.disabled||i.disabled,icon:s.icon};this.props.label&&(r.children=[this.props.label]),(this.props.loading||i.loading)&&a.applyLoadingState.call(this,r),r.icon&&a.applyIcon.call(this,r),r.disabled&&(r.className+=" disabled");var n=t.defaults({className:t.mergeClassNames("ui button",this._className,r.className)},this.props);return e.DOM.button(n,r.children)}}};return t.init(a,s),a}},{}],4:[function(e,t){t.exports=function(e,t,a){function s(e,t){return t.defaultValue||e.getModelValue()}e.mixins.add("modelValueAccessor",{getModelValue:function(){return this.state&&this.state.value||this.props.value},setModelValue:function(e){this.setState({value:e})}});var i,r={mixins:{all:["modelValueAccessor"]},optionsRetriever:function(e){var t=(this.props.options||[]).map(function(t){var a,s,i;return"string"==typeof t?(i=e===t,s=t,a=t):(i=e===t.value,s=t.value,a=t.label),{value:s,label:a,selected:i}});return this.props.placeholder&&t.splice(0,0,{value:"",label:this.props.placeholder}),t}},n={Text:{renderInput:function(t){return t.type=t.type||"text",t.defaultValue=s(this,t),t.className=a.mergeClassNames(t.className,this._className),e.DOM.input(t)}},TextArea:{renderInput:function(t){return t.defaultValue=s(this,t),t.className=a.mergeClassNames(t.className,this._className),e.DOM.textarea(t)}},Select:{defaultContainerClass:function(){return a.mergeClassNames("ui dropdown",this.props.type)},renderInput:function(t){var i=s(this,t);return options=r.optionsRetriever.call(this,i).map(function(t){return e.DOM.option({value:t.value},t.label)}),t.defaultValue=i,t.className=a.mergeClassNames(t.className,this._className),e.DOM.select(t,options)}},Checkbox:{defaultLabelAfter:!0,defaultInlineLabel:!0,defaultContainerClass:function(){return a.mergeClassNames("ui checkbox",this.props.type,this._className)},renderInput:function(t){var i=s(this,t);return void 0===i&&(i=this.props.defaultChecked),t.defaultChecked=i,t.value=this.props.value||"true",t.type="checkbox",t.className=a.mergeClassNames(t.className),e.DOM.input(t)},getDOMValue:function(e){return!!e.checked}},RadioGroup:{defaultContainerClass:function(){return"grouped fields inline"},renderInput:function(t){var i=this,n=(this.state,s(this,t)),l=r.optionsRetriever.call(this,n).map(function(s){var r=a.uniqueId(),n=a.mergeClassNames("ui radio checkbox",t.className,this._className);return e.DOM.div({className:"field"},e.DOM.div({className:n},e.DOM.input({id:r,type:"radio",name:t.name,value:s.value,defaultChecked:s.selected,onChange:a.eventBinder(s.value,"onChange",i)}),e.DOM.label({htmlFor:r},s.label)))});return l}},Dropdown:{render:function(){var t=this.props,i=s(this,t),n=r.optionsRetriever.call(this,i).map(function(t){return e.DOM.div({className:a.mergeClassNames("item",t.selected?"active":void 0),"data-value":t.value},t.label)}),l=a.omit(t,["label","className","options","value","icon","onChange","onShow","onHide"]);return l.type="hidden",l.defaultValue=i,e.DOM.div({className:a.mergeClassNames("ui dropdown "+(t.type||"floating"),t.className,this._className)},e.DOM.input(l),e.DOM.div({className:"text"},t.label),e.DOM.i({className:(t.icon||"dropdown")+" icon"}),e.DOM.div({className:"menu"},n))},componentDidMount:function(){$(this.getDOMNode()).dropdown({onChange:this.props.onChange,onShow:this.props.onShow,onHide:this.props.onHide})},getDOMValue:function(){return $(this.getDOMNode()).dropdown("get value")}}};return e.mixins.exists("modelFieldValidator")&&(r.defaultModelSetOptions={validate:!0,allowEmpty:!0},e.mixins.add("modelChangeSetter",{modifyInputFieldProps:function(e){{var t=e.onChange;this.getModel(),e.key}if((void 0===e.set||e.set===!0)&&(e.set=r.defaultModelSetOptions,e.set)){var a=this;e.onChange=function(s){var i=a.getModel();if(i){var r=a.getDOMValue(s.currentTarget);a.setModelValue(r,e.set)!==!1&&a.state&&a.state.error&&a.setState({error:!1}),t&&t.call(a,s)}}}return e}},"modelValueAccessor","modelEventBinder"),i=["modelChangeSetter","modelFieldValidator"]),a.init(r,n,{defaults:{render:t.fieldRenderer,getDOMValue:function(e){return $(e).val()}},mixins:i}),r}},{}],5:[function(e,t){t.exports=function(e,t){var a={totalPageRetriever:function(){return this.props.totalPages},valueRetriever:function(e,t){return t.get?t.get(e.key):t[e.key]},entriesRetriever:function(e){return e.models?e.models:e}},s={Loader:{render:function(){{var a=this.props;this.state&&this.state.loading||a.loading}if(this.props.loading||this.state&&this.state.loading){var s=t.mergeClassNames("ui","segment",a.className);return loadingClass=t.mergeClassNames("ui active",a.type||"inverted dimmer"),e.DOM.div({className:s},e.DOM.div({className:loadingClass},e.DOM.div({className:"ui loader"+(a.label?" text":"")},a.label)),this.props.children)}return e.DOM.div({className:a.className},this.props.children)}},Steps:{getInitialState:function(){return{active:this.props.active||this.props.steps[0].key}},render:function(){var a=this,s=this.props,i=t.mergeClassNames("ui steps",s.type,s.className),r=this.state.active,n=s.steps.map(function(s){var i=t.mergeClassNames("ui step",s.key===r?"active":void 0,s.disabled?"disabled":void 0);return e.DOM.div({className:i,onClick:a.clicker(s)},s.label)});return e.DOM.div({className:i},n)},clicker:function(e){var t=this;return function(){if(!e.disabled){var a=t.props.onChange&&t.props.onChange(e);(void 0===a||a)&&t.setState({active:e.key})}}}},Paginator:{getInitialState:function(){return{page:this.props.page||1}},render:function(){var s=a.totalPageRetriever.call(this);if(s&&s>1){var i=this.state.page,r=this.props.radius||0,n=this.props.anchor||1,l=this.props.separator||"...",o=Math.max(i-r,1),c=Math.min(i+r,s),u=void 0===this.props.showArrows?!0:this.props.showArrows,d=2*r+2*n+3,p=s>i+r+n,m=i>n+Math.max(1,r),h=this.props.compact,f={},v=[];h&&(u=!1),m&&d--,p&&d--;var g;for(g=1;n>=g&&s>=g;g++)v.push(g),f[g]=v.length;for(g=o;c>=g;g++)f[g]||(v.push(g),f[g]=v.length);for(g=Math.max(s-n+1,i+1);s>=g;g++)f[g]||(v.push(g),f[g]=v.length);for(g=i;g>0&&v.length<d;g--)"undefined"==typeof f[g]&&(_idx=f[g+1]-1,v.splice(_idx,0,g),f[g]=_idx+1);for(g=i;v.length<d&&v.length<s;g++)f[g]||v.splice(g-1,0,g);var N=this;if(v=v.map(function(a){return a===i?e.DOM.div({className:"active item"},a):e.DOM.a({className:"item",href:"#"+a,onClick:t.eventBinder(a,"onChange",N,!0)},a)}),m&&(h?v.splice(n,0,e.DOM.a({className:"icon item"},e.DOM.i({className:"left arrow icon",onClick:t.eventBinder(i-1,"onChange",N,!0)}))):v.splice(n,0,e.DOM.div({className:"disabled item"},l))),p&&(h?v.splice(v.length-n,0,e.DOM.a({className:"icon item"},e.DOM.i({className:"right arrow icon",onClick:t.eventBinder(i+1,"onChange",N,!0)}))):v.splice(v.length-n,0,e.DOM.div({className:"disabled item"},l))),u){var C,b;1===i?(C="div",b="icon disabled item"):(C="a",b="icon item"),v.splice(0,0,e.DOM[C]({className:b,onClick:i>1?t.eventBinder(i-1,"onChange",N,!0):void 0},e.DOM.i({className:"left arrow icon"}))),i===s?(C="div",b="icon disabled item"):(C="a",b="icon item"),v.splice(v.length,0,e.DOM[C]({className:b,onClick:s>i?t.eventBinder(i+1,"onChange",N,!0):void 0},e.DOM.i({className:"right arrow icon"})))}return e.DOM.div({className:"ui pagination menu"},v)}return e.DOM.div()},onChange:function(e){this.setState({page:e})},setPage:function(e){this.setState({page:e})}},Menu:{getInitialState:function(){return{active:this.props.active||this.props.items[0].key}},render:function(){for(var a,s=this,i=this.props,r=i.items||[],n=this.state.active,l=0;r>l;l++)if(n===r[l].key){a=r[l];break}var o=r.map(function(a){return e.DOM.a({className:t.mergeClassNames(a.key===n&&"active","item",a.className),href:a.key,onClick:t.eventBinder(a,"onChange",s,!0)},a.icon?e.DOM.i({className:a.icon+" icon"}):void 0,a.label)});return e.DOM.div({className:t.mergeClassNames("ui menu",i.className)},o,i.children)},onChange:function(e){this.setState({active:e.key}),e.activate&&e.activate()},setActive:function(e){this.setState({active:e})}},Tabs:{getInitialState:function(){return{active:this.props.active||this.props.tabs[0].key}},render:function(){for(var a,s=this,i=this.props,r=i.tabs||[],n=i.type||"top attached tabular",l=i.bodyType||"bottom attached segment",o=this.state.active,c=0;c<i.tabs.length;c++)if(o===i.tabs[c].key){a=i.tabs[c];break}var u=r.map(function(a){return e.DOM.a({className:t.mergeClassNames(a.key===o&&"active","item",a.className),href:a.key,onClick:t.eventBinder(a,"onChange",s,!0)},a.icon?e.DOM.i({className:a.icon+" icon"}):void 0,a.label)}),d=a.page();return e.DOM.div({className:i.className},e.DOM.div({className:"ui "+n+" menu"},u),e.DOM.div({className:"ui "+l},d))},onChange:function(e){this.setState({active:e.key})}},Table:{render:function(){var s=this,i=this.props,r=i.cols.map(function(a){var i=t.result(a.label),r=a.colClass;return"function"==typeof r&&(r=r.call(s,value,a)),e.DOM.th({className:r},i)}),n=0,l=a.entriesRetriever.call(this,i.entries).map(function(t){var r=i.cols.map(function(i){var r=a.valueRetriever.call(this,i,t),l=i.cellClassName;return"function"==typeof l&&(l=l.call(s,r,i)),n++,i.formatter&&(r=i.formatter.call(this,r,t,n,i)),i.factory&&(r=i.factory.call(this,r,t,n,i)),e.DOM.td({className:l},r)}),l=i.rowClassName&&i.rowClassName.call(this,t);return e.DOM.tr({className:l},r)});return e.DOM.table({className:t.mergeClassNames("ui table",i.className)},e.DOM.thead(void 0,r),e.DOM.tbody(void 0,l))}}};return t.init(a,s),a}},{}]},{},[1]);
