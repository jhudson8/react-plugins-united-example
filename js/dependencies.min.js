...
react-mixin-manager v0.3.0
react-events v0.1.2
react-backbone v0.1.2
Semantic UI Version: 0.16.1
*/
 ...
 */
!function(n){"function"==typeof define&&define.amd?define(["backbone","underscore"],function(e,t){n(e,t)}):"undefined"!=typeof exports&&"undefined"!=typeof require?module.exports=function(e){n(e,require("underscore"))}:n(Backbone,_)}(function(n,e){var t=n.sync;n.sync=function(i,r,s){function c(n){var e=s[n];s[n]=function(){var t=arguments;e&&e.apply(this,t);var i=o.indexOf(d);i>=0&&o.splice(i,1);var c="success"===n?[n,r,s]:[n,r,t[1],t[2],s];d.trigger.apply(d,c),c.splice(0,0,"complete"),d.trigger.apply(d,c),0===o.length&&r.trigger("async:load-complete")}}s=s||{};var o=r._pendingAsyncEvents=r._pendingAsyncEvents||[],a=s&&s.event||i,d=e.extend({},n.Events);o.push(d),d.method=i,d.options=s,d.model=r,r.trigger("async",a,d,s),r.trigger("async:"+a,d,s),n.asyncHandler&&(n.asyncHandler.trigger("async",a,r,d,s),n.asyncHandler.trigger("async:"+a,r,d,s)),c("success"),c("error");var p=s.abort;if(p){if("function"==typeof p)return p(s);throw"abort must be function(options)"}t.call(this,i,r,s)},e.each([n.Model,n.Collection],function(n){n.prototype.isLoading=function(){return this._pendingAsyncEvents&&this._pendingAsyncEvents.length>0?this._pendingAsyncEvents:!1}})});
